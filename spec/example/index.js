...
"use strict";var src_1=require("../../src"),debug=require("debug"),log=debug("example"),string$=src_1.default(["abc","ABC","012"]),subset$=string$.skip(15).take(5);subset$.forEach(log);
},{"../../src":73,"debug":undefined}],73:[function(require,module,exports){
"use strict";function combination$(t){var n=assertAlphabetStream(stream(t),"invalid argument"),r=n.map(function(t){return stream(t)}),e=n.constant(1).reduce(sum,0);return unwrap(e.then(function(t){return r.skip(1).scan(combine,r.take(1).join()).slice(t-1,void 0).join()}))}function combine(t,n){return t.flatMap(function(t){return n.map(function(n){return t+n})})}function sum(t,n){return t+n}function unwrap(t){return most_1.fromPromise(t).join()}function assertAlphabetStream(t,n){return unwrap(isValidAlphabetStream(t).catch(function(){return!1}).then(function(n){return n?t:Promise.reject(new TypeError("invalid argument"))}))}function reject(t){}function isValidAlphabetStream(t){return t.reduce(function(t,n){return t&&isValidAlphabet(n)},!0)}function isValidAlphabet(t){return isString(t)&&!!t.length}function stream(t){try{return most_1.from(t)}catch(t){return most_1.throwError(t)}}function isString(t){return"string"==typeof(t&&t.valueOf())}var most_1=require("most");Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=combination$;
},{"most":39}]},{},[72]);
